<?php
/**
 * Unit testing for Standart, if the plugin is activated.
 *
 * @package   @@pkg.title
 * @author    @@pkg.author
 * @license   @@pkg.license
...
/**
 * Main Block_Unit_Test_Standart Class
 *
 * @since 1.0.3
 */
class Block_Unit_Test_Standart {

	/**
	 * The class instance.
	 *
	 * @var Block_Unit_Test_Standart
	 */
	...
	public static function register() {
		if ( null === self::$instance ) {
			self::$instance = new Block_Unit_Test_Standart();
		}
	}
	...
	private function __construct() {
		add_action( 'admin_init', array( $this, 'create_standart_unit_test_page' ) );
		add_action( 'admin_init', array( $this, 'update_standart_unit_test_page' ) );
	}

	/**
	 * Creates a page for the Standart to be rendered on.
	 */
	public function create_standart_unit_test_page() {

		$title = apply_filters( 'block_unit_test_standart_title', 'Standart Wordpress Blocks Unit Test ' );
		...
		wp_insert_post(
			array(
				'post_title'     => $title,
				'post_content'   => $this->standart_content(),
				'post_status'    => 'draft',
				'post_author'    => 1,
				'post_type'      => 'page',
	...
	/**
	 * Updates the Standart page upon plugin updates.
	 */
	public function update_standart_unit_test_page() {
	...
	public function standart_content() {
		...
		return apply_filters( 'block_unit_test_standart_content', $content );
	}
}
Block_Unit_Test_Standart::register();
